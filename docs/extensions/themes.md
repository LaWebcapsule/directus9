...
- **Themes** — See the [Light Theme](https://github.com/pxslip/db-studio/blob/main/app/src/styles/themes/_light.scss)
  or [Dark Theme](https://github.com/pxslip/db-studio/blob/main/app/src/styles/themes/_dark.scss)
