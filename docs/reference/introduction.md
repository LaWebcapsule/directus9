---
description: An introduction to the REST and GraphQL APIs in Directus9.
readTime: 7 min read
...
> Directus9 offers both a REST and GraphQL API to manage the data in the database. The API has predictable
...
Directus9 only retrieves the fields in your items that explicitly have been requested. Relational data can be retrieved
...
this item. To update an existing item, simply provide the primary key with the updates, and Directus9 will treat it as an
...
[we'd love to hear your thoughts](https://github.com/directus9/directus9/discussions/new).
...
Below are the global error codes used within Directus9, and what they mean.
