---
description: A breakdown of the Directus9 platform architecture.
readTime: 2 min read
---

# Architecture

> Directus9 is a wrapper for both your database and file asset storage system.

At first glance, it may be tempting to think of Directus9 as an app-centric platform. But that's not the case. The app is
...
![Directus9 Architecture Graphic](https://cdn.directus9.io/docs/v9/getting-started/architecture/architecture-20220512/directus9-architecture-20220512A.webp)

## The Database

Directus9 is plug-and-play. Once linked, it doesn't _own_ your data or file assets, but it does create about 20 new data
tables which are required for platform operation. These tables do not intermingle with the rest of your data, so you can
remove Directus9 without a trace. You also have the freedom to access the database with raw SQL queries, link up any
...
vendor you choose, the platform works seamlessly. Similarly, Directus9 syncs with your configured file storage service,
...
Directus9 provides secure user access methods. Choose access token format and configure authentication as desired. You
...
The Directus9 JS-SDK is [available via NPM](https://www.npmjs.com/package/directus9). You also have access to two
Command-Line Interfaces (CLI). One enables server-side actions relating to your on-prem instance, like migrating the
database or resetting a user. The other allows you to interact with a Directus9 instance as you would with an SDK.

## The Data Studio

The Directus9 Data Studio is a no-code dashboard that brings the whole team together.
...
Directus9 is 100% open-source, modular, and extensible, ensuring you will never hit a hard feature ceiling within the
...
Directus9 follows a SemVer-like versioning structure, but it's important to note that it does not follow SemVer
precisely. For complex systems like Directus9, SemVer doesn't really scale as any tweak to any part of the codebase could
